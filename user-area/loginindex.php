...
<div id='bodyDiv'>
    ...
    <a class="navbarButton" href="javascript:alert('coming soon')"><i class="fa-solid fa-arrow-right-to-bracket"></i> Login</a>
...
<div id="mobileNavbar"><br> <center>
    <a class="mobileNavbarButton" id='HomeBtn' onclick="home()"><i class="fa-solid fa-house"></i> Home</a>
    ...
    <div class="container">
        <div class="registerContainer"><br><br>
            <h2 id="registerLabel">Login Here:</h2>
